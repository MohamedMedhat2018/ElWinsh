...
public class MapFragment extends Fragment implements OnMapReadyCallback,
    ...
    private int counter = 0, max = 30, tansX1, tansX2;
...
//        int res = width / 2 - width2;
        ...
        width = (int) (w - w / 2.5);
//        Log.e(TAG, "finalWidth  ==  " + finalWidth + " width2  = " + width);
//        last = finalWidth;
...
//        LocationUsingGps(this.getView());
    ...
    private void getRectOfView() {
        ...
        Rect rectf = new Rect();
        cardView.getLocalVisibleRect(rectf);
        ...
        YoYo.with(Techniques.FadeOut)
                ...
                .onEnd(new YoYo.AnimatorCallback() {
                    ...
                    public void call(Animator animator) {
                        imageView_truck1.setVisibility(View.GONE);
//                        getView().findViewById(R.id.tv_truck2).setVisibility(View.VISIBLE);
